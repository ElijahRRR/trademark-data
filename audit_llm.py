...
【⚠️ 汽配搬运场景极高危 — 必须加强审查】
搬运卖家做汽配/摩配在沃尔玛几乎 100% 被拒 (IP+BIZ 双重打击):
- 任何 "for [车品牌/车型]" / "compatible with [车品牌]" / "fits [车品牌]" 描述 → 至少 hold
  包括: Toyota, Ford, Chevy, BMW, Mercedes, Honda, Jeep, Tesla, Harley, Ducati, Kawasaki 等
  以及具体车型: F-150, Wrangler, Camry, Mustang, Civic, RAV4, Silverado, Cherokee 等
- 类目路径含 "Automotive Replacement" / "Motorcycle Parts" / "ATV Parts" / "Exterior Auto" / "Interior Auto" →
  ip_risk 至少 60, 大概率直接 reject
- 汽配通用配件 (螺丝/垫片/管夹/卡扣) 若描述"万能通用", 可能相对低风险但仍建议 hold
- 唯一可 approve 的汽配: 明确通用件 + 不提及任何品牌 + 不在 Automotive Replacement 子类
